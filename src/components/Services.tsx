        ...
        <div className="mt-14 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {site.services.items.map((service) => (
            <Reveal key={service.title}>
              <article className="group relative flex h-full min-h-[420px] flex-col overflow-hidden rounded-2xl border border-paper-200 bg-paper-50 p-7 shadow-soft transition hover:-translate-y-1 hover:bg-white hover:shadow-lift">
